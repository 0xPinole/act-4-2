function trayect(hxd, hyd, K, ts, t, xmn, xmx, ymn, ymx)
N= length(t);      % Muestras
...
scale = 1;
MobileRobot;
%H1=MobilePlot(x1(1),y1(1),phi(1),scale);
hold on;
...
H1=MobilePlot(x1(N),y1(N),phi(N),scale);
H2=plot3(hx(1:N),hy(1:N),zeros(1,N),'r','lineWidth',2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Graficas %%%%%%%%%%%%%%%%%%%%%%%%%%%%
